...
export class PostgresDriver implements DbDriver {
  ...
  public async postRestoreFixups(_exec: Exec): Promise<void> {
    this.logger.debug('Postgres sequence reset skipped — pgloader/Directus handle sequences');
  }
  ...
  public async dropAllTables(exec: Exec): Promise<void> {
    await this.executeSql(exec, 'DROP SCHEMA public CASCADE; CREATE SCHEMA public;');
  }
